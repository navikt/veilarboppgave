...
import no.nav.veilarboppgave.domene.*;
...
import static no.nav.veilarboppgave.domene.OppgaveType.utledOppgaveTypeKode;
import static no.nav.veilarboppgave.domene.Prioritet.utledPrioritetKode;
